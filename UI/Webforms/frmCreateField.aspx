...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        <section>
            <div>
                <asp:Label ID="LabelEstablishment" runat="server" Text="Establecimiento"></asp:Label><br />
                <asp:DropDownList ID="DropDownListEstablishment" runat="server">
                </asp:DropDownList><br />

                <asp:Label ID="LabelFieldName" runat="server" Text="Nombre de la cancha"></asp:Label><br />
                <asp:TextBox ID="TextBoxFieldName" runat="server"></asp:TextBox><br />

                <asp:Label ID="LabelSize" runat="server" Text="Tamaño"></asp:Label><br />
                ...
                <asp:Label ID="LabelFieldType" runat="server" Text="Tipo de piso"></asp:Label><br />
                ...
                <asp:Label ID="LabelAvailability" runat="server" Text="Disponibilidad"></asp:Label><br />
                <asp:DropDownList ID="DropDownListStartHour" runat="server"></asp:DropDownList>
                <asp:Label ID="LabelTo" runat="server" Text="hasta"></asp:Label>
