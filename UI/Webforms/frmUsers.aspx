        ...
        <section class="container-listEmployees">
            <asp:GridView ID="GridView1" runat="server">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandArgument='<%# Eval("username") %>'
                                OnClick="ButtonEdit_Click"><i class="bi bi-pencil-square"></i></asp:LinkButton>
                            <asp:LinkButton runat="server" CommandArgument='<%# Eval("username") %>' OnClick="ButtonDelete_Click" OnClientClick="return confirm('Desea eliminar?')"><i class="bi bi-trash3-fill"></i></asp:LinkButton>
